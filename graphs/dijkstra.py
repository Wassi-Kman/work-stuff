...
if __name__ == "__main__":
    ...
    distances, path_dict = dijkstra(city_graph2, "Naivasha")
    name_distance: Dict[str, Optional[int]] = distance_array_to_vertex_dict(city_graph2, distances)
    print("Distances from Naivasha:")
    for key, value in name_distance.items():
        print(f"{key} : {value}")
    print("") # blank line

    print("Shortest path from Naivasha to Kisumu:")
    path: WeightedPath = path_dict_to_path(city_graph2.index_of("Naivasha"), city_graph2.index_of("Kisumu"), path_dict)
